        ...
        <div className="min-h-screen bg-background flex flex-col justify-center items-center p-4 relative overflow-hidden">
            ...
            <div className="w-full max-w-md bg-surface rounded-2xl shadow-xl border border-white/10 relative z-10 p-8">
                <div className="text-center mb-8">
                    <div className="bg-primary/10 w-12 h-12 rounded-xl flex items-center justify-center text-primary mx-auto mb-4">
                        <Sprout size={24} />
                    </div>
                    <h1 className="text-2xl font-bold font-display text-foreground">Bon retour !</h1>
                    <p className="text-text-secondary text-sm mt-1">Connectez-vous pour accéder à votre espace.</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div>
                        <div className="flex justify-between items-center mb-1.5">
                            ...
                            <a href="#" className="text-xs text-primary font-medium hover:underline">Oublié ?</a>
                        </div>
                        <div className="relative">
            ...
            <div className="mt-8 text-center text-xs text-text-tertiary">
                © 2026 AgriAssist CI. <a href="#" className="hover:text-text-secondary">Conditions</a> • <a href="#" className="hover:text-text-secondary">Confidentialité</a>
            </div>
        </div>
    );
}
